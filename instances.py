...
#     # can add another variable, after self, ex legs. and you can assign that to a variable inside the class
#     # when you call the object and supply the number of legs the dogs has, it is assigned to the variable
